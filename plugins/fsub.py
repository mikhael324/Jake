...
async def Force_Sub(bot: Client, message: Message, fileid=None):
    ...
    try:
        ...
        await bot.send_message(
            chat_id=message.from_user.id,
            text=f"Hey {message.from_user.mention}😍,\n\n♦️ 𝗥𝗘𝗔𝗗 𝗧𝗛𝗜𝗦 𝗜𝗡𝗦𝗧𝗥𝗨𝗖𝗧𝗜𝗢𝗡𝗦♦️\n\Click on below join link 𝐑𝐞𝐪𝐮𝐞𝐬𝐭 𝐭𝐨 𝐣𝐨𝐢𝐧 on the channel and you will get the movie...😁\n\n<b>♦️महत्वपूर्ण♦</b>\n\nचैनल पर नीचे दिए गए लिंक 𝐑𝐞𝐪𝐮𝐞𝐬𝐭 𝐭𝐨 𝐣𝐨𝐢𝐧 पर क्लिक करें और आपको फिल्म मिल जाएगी...😁\n\n<b>♦ശ്രദ്ധിക്കുക♦</b>\n\nതാഴെ ഉള്ള ജോയിൻ ലിങ്കിൽ ക്ലിക്ക് ചെയ്തു 𝐑𝐞𝐪𝐮𝐞𝐬𝐭 𝐭𝐨 𝐣𝐨𝐢𝐧 ക്ലിക്ക് ചെയ്ത് ചാനെലിൽ ചെയ്‌താൽ നിങ്ങൾക് സിനിമ ലഭിക്കുന്നതാണ്...😁", 
            parse_mode=enums.ParseMode.HTML,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(btn)
        )
        return False #Ansh vachhani
